...
define('_CONST_UNIT_NAME_ERRORS', 'Cổng thông tin điện tử');

//Mặc định số bản ghi hiển thị trên một trang
define('_CONST_DEFAULT_ROWS_PER_PAGE', 10); // 10
define('_CONST_DEFAULT_ROWS_OTHER_NEWS', 5);
...
//limit article new
define('_CONST_DEFAULT_LIMIT_ARTICLE_NEW', 6);
...
define('CFGKEY_UNIT_REPOSIBLE_FOR_CONTENT', 'responsible_for_content');
...
define('_CONST_DM_HELP','DM_HELP');

define('_CONST_MIN_ROW_TO_MYSQL_USE_INDEX', 500);

define('_CONST_TYPE_FILE_ACCEPT', 'doc,pdf,docx');
...
//subject mac dinh
define('CONTS_MAIL_SUBJECT',  "Cổng thông tin điện tử Mai Sơn ngày");
...
//apps dir
define('_CONST_IMAGE_DEFAULT_STICKY','default_sticky.jpg');
define('_CONST_LIMIT_NEW_DOCUMENT',6);

//CONST LIST
define('_CONST_LIST_DS_DOI_TAC', 'DS_DOI_TAC');
