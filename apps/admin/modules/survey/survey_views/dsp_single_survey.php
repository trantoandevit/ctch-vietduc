...
<form name="frmMain" id="frmMain" method="POST" action="">
    ...
    ?>
    <h1 class="page-header" style="width: auto; font-size: 32px;"><?php echo __('detailed survey questions'); ?></h1>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="row" style="margin-bottom: 20px;">
                <div class="col-lg-12">
                    <div class="col-lg-2"><label><?php echo __('question name'); ?></label></div>
                    <div class="col-lg-6">                   
                        <input type="text" class="form-control" name="txt_survey_name" id="txt_survey_name" 
                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-6">
                        <div class="input-group date" id="bg_date" style="width: 100%; display: block;">
                            <input type="text" name="txt_begin_date" id="txt_begin_date" class="form-control"
                                   value="<?php echo $v_begin_date; ?>" 
                                   data-allownull="no" data-validate="date" 
                                   data-name="<?php echo __('ngày bắt đầu') ?>" 
                                   data-xml="no" data-doc="no" style="width:90%"
                                   autofocus="autofocus" />
            ...
            <div class="row" style="margin-bottom: 20px;">
                <div class="col-lg-12">
                    <div class="col-lg-2"><label><?php echo __('end date'); ?></label></div>
                    <div class="col-lg-6">
                        ...
                        <div class="input-group date" id="ed_date" style="width: 100%; display: block;">
                            <input type="text" name="txt_end_date" id="txt_end_date" class="form-control"
                                   ...
                                   data-allownull="no" data-validate="date" style="width:90%"
                                   data-name="<?php echo __('ngày kết thúc') ?>" 
                                   data-xml="no" data-doc="no" 
                                   autofocus="autofocus" style="width: 100%"/>
                            <span class="input-group-addon" style="width:10%; height: 34px;">
                                <span class="glyphicon glyphicon-calendar"></span>
                            </span>
            ...
            <div class="row" style="margin-bottom: 20px;">
                <div class="col-lg-12">
                    <div class="col-lg-2"><label><?php echo __('unit survey'); ?></label></div>
                    <div class="col-lg-6">
                        <select class="form-control" name="sel_member" id="sel_member">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-6">
                        <label><input type="checkbox" name="chk_status" <?php
                            echo ($v_status == 1) ? 'checked' : '';
                            ?> id="chk_status" > <?php echo __('display'); ?></label>
                    </div>
                </div>
            </div>
        ...
        <div class="panel-footer">
            <div class="button-area">
                <button type="button" class="btn btn-outline btn-success" name="btn_update" id="btn_update" class="ButtonAccept" onclick="  btn_update_onclick();"><i class="fa fa-check"></i> <?php echo __('update'); ?></button>
                <button type="button" class="btn btn-outline btn-warning" name="btn_back" id="btn_cancel" class="ButtonBack" onclick="btn_back_onclick();"><i class="fa fa-reply"></i> <?php echo __('go back'); ?></button>
            </div>
        </div>
    </div>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
                ...
                for($i=0 ;$i< sizeof($arr_all_question); $i ++)
                {
                    ...
                    ?>
            <div class="" id="question_old_<?php echo $v_question_id; ?>" data-new="0" data-old="<?php echo $v_question_id; ?>">
                <div>
                    <div class="row" style="margin-bottom: 20px;">
                        <div class="col-lg-12">               
                            <div class="col-lg-2"><label><?php echo __('manager field'); ?></label></div>
                                <div class="col-lg-6">
                                    <input type="text" value="<?php echo $v_question_type_name; ?>" disabled="true" name="txt_question_type_name_old_<?php echo $v_question_id ?>" class="form-control" >
                                    <input type="hidden" value="<?php echo $v_question_type; ?>" name="txt_question_type_old_<?php echo $v_question_id ?>" class="form-control" >
                                    <input type="hidden" name="txt_url" class="txt_url" class="form-control" value='<?php echo $v_url; ?>' >
                                </div>
                            </div>
                    </div>
                    <div class="row" style="margin-bottom: 20px;">
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" value="<?php echo $v_question_name; ?>" disabled="true"  name="txt_question_name_old_<?php echo $v_question_id ?>" class="txt_question_name" >
                                </div>
                            </div>
                    </div>
                     <!--End Cau hoi-->  
                    ...
                    if(trim($v_xml_answer)!= '')
                    {
                        ...
                        for($o = 0;$o< sizeof($arr_answer); $o ++)
                        {
                            ...
                            if(trim($v_answer_name) != '')
                            {
                                if($o == 0)
                                {
                                    echo '<div class="row answer" style="margin-bottom: 20px;">
                                            <div class="col-lg-12">
                                            <div class="col-lg-2"><label>' . __('enter the answer') . '</label></div>
                                            <div class="col-lg-6 answer">
                                                <input type="text" class="form-control" disabled="true" value="'.$v_answer_name.'"  name="txt_answer_name_old_'.$v_question_id.'[]">
                                                <input type="hidden" class="form-control" value="'.$v_answer_id.'" name="text_question_answer_id_old_'. $v_question_id.'[]" id="text_question_result" size="80">
                                            </div>
                                            </div>
                                        </div>';
                                }
                ...
                <div class="row" style="margin-bottom: 20px;">
                                ...
                                <div class="col-lg-8" style="float: right;">
                                        ...
                                        <button type="button" class="btn btn-outline btn-danger" onclick="btn_delete_question_onclick(this);">
                                            <i class="fa fa-times"></i> <?php echo __('delete'); ?></button> &nbsp;
                                        <button  class="btn btn-outline btn-success" type="button" onclick="btn_onclick_edit_question(this);" data-status="old">
                                            <i class="glyphicon glyphicon-pencil "></i> <?php echo __('edit question'); ?></button>
                                    </div>
            ...
            <div class="box-question_answer" id="question_old_" data-new="0" data-old="0">
                ...
                <div class="div-question">
                    <div class="row cat-question">
                        <div class="left-Col"><?php echo __('manager field'); ?></div>
                        <div class="right-Col">
                            <input type="text"  disabled="true" name="txt_question_type_name" class="form-control" >
                            <input type="hidden"  name="txt_question_type" class="txt_question_type" >
                            <input type="hidden"  name="txt_url" class="txt_url" value="" >
                        </div>
                    </div>
                    <div class="row question">
                        <div class="left-Col"><?php echo __('question'); ?></div>
                        <div class="right-Col">
                            <input type="text" disabled="true"  name="txt_question_name" class="form-control" >
                        </div>
                    </div>
                    <div class="row answer">
                       <div class="left-Col"><?php echo __('enter the answer'); ?></div>
                       <div class="right-Col answer">
                           <input type="text" disabled="true"  name="txt_answer_name" class="form-control" >
                           <input type="hidden" value="0" name="text_question_answer_id_old_" class="form-control" size="80">
                       </div>
                   </div>
                </div>
                 <div class="row">
                       ...
                       <div class="right-Col answer">
                           <button type="button" class="btn btn-outline btn-danger" onclick="btn_delete_question_onclick(this);">
                               <i class="fa fa-times"></i> <?php echo __('delete'); ?></button>
                           <button  class="btn btn-outline btn-success" type="button" onclick="btn_onclick_edit_question(this);">
                               <i class="glyphicon glyphicon-pencil "></i> <?php echo __('edit question'); ?></button>
                       </div>
                   </div>
               </div>
        ...
        <!--End #template-answer-->
            <button style="float: right;" type="button" class="btn btn-outline btn-primary" onclick="btn_add_question_onclick();">
                <i class="fa fa-plus"></i> <?php echo __('add question'); ?>
            </button>
        ...
        <div class="panel-footer" style="text-align: right;">
            <div class="button-area">
                <button type="button" name="btn_update"  id="btn_update" class="btn btn-outline btn-success" onclick="btn_update_onclick();">
...
function btn_add_question_onclick()
{
    ...
    showPopWin(url,700,500,do_add_question,true);
