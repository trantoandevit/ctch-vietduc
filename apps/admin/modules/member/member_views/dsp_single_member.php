...
<form name="frmMain" id="frmMain" action="" method="POST">
    ...
    <!-- Toolbar -->
    <h1 class="page-header"><?php echo __('member detail'); ?></h1>
    <!-- /Toolbar -->
    <div class="row" style="margin-bottom: 20px;">
            <div class="col-lg-12">
            <div class="col-lg-2">
                <label><?php echo __('name member');?>
                <b style="color: red;">(*)</b></label>
            </div>
            <div class="col-lg-5">
                <input type="textbox" class="form-control" name="txt_member_name" id="txt_member_name" value="<?php echo $v_member_name;?>" 
        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-lg-12">
            <div class="col-lg-2">
                <label><?php echo __('code member'); ?>
                 <b style="color: red;">(*)</b></label>
            </div>
            <div class="col-lg-5">
                <input type="textbox" name="txt_member_code" class="form-control" id="txt_member_code" value="<?php echo $v_member_code; ?>" 
                       data-allownull="no" data-validate="text" 
        ...
        <!--short code-->
        <div class="row" id="short_code" style="margin-bottom: 20px;">
            <div class="col-lg-12">
            <div class="col-lg-2">
               <label> <?php echo __('short code') .'(' .__('use for record no').')'; ?>
               <b style="color: red;">(*)</b></label>
            </div>
                <div class="col-lg-5" style="padding-top:10px;">
                <input type="textbox" name="txt_short_code" class="form-control" id="txt_short_code" value="<?php echo $v_short_code; ?>" 
                       data-allownull="no" data-validate="text" 
       ...
       <!--End member code-->
        <div class="row">
            <div class="col-lg-12" style="margin-bottom: 20px;">
                ...
                <div class="col-lg-5">
                    <input type="textbox" name="txt_member_address" class="form-control" id="txt_member_address" value="<?php echo $v_member_address;?>" 
                            data-allownull="no" data-validate="text" 
       ...
       <!--End member address-->
        ...
        <div class="row" id="exchange_email" style="margin-bottom: 20px;">
            <div class="col-lg-12">
                <div class="col-lg-2">
                   <label><?php echo __('member email');?>
                     <b style="color: red;">(*)</b></label>
                </div>
                <div class="col-lg-5">
                    <input type="textbox" class="form-control" name="txt_member_email" id="txt_member_email" value="<?php echo $v_member_email;?>" 
       ...
       <!--End member email-->
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-lg-12">
            <div class="col-lg-2">
                <label><?php echo __('member level'); ?>
                <b style="color: red;">(*)</b></label>
            </div>
            <div class="col-lg-5">
        ...
        <div id="box-member-level-2" class="row" style="margin-bottom: 20px;">
            <div class="col-lg-12">
            <div class="col-lg-2">
                <label> <?php echo __('of units member'); ?>
                <b style="color: red;">(*)</b></label>
            </div>
            <div class="col-lg-5">
                <div style="float: left">
                    <select class="form-control" name="sel_member_parent" id="sel_member_parent" style="min-width: 330px" onchange="get_village(this)">
        ...
        <div class="row" id="row_village">
            <div class="col-lg-12">
            <div class="col-lg-2">
                <label><?php echo __('is village')?>
                    <b style="color: red;">(*)</b></label>
            </div>
            <div class="col-lg-5" id="div_village" style="height: 200px;overflow: scroll;display: block;"> 
            </div>
            </div>
        </div>
        <!--end is village-->
        ...
        <div class="button-area">
            <button type="button" name="btn_update" id="btn_update" class="btn btn-outline btn-success" onclick="update_member();">
