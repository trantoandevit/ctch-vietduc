...
?>
    <!-- Toolbar -->
    <h1 class="page-header"><?php echo __('banner detail'); ?></h1>
    <!-- /Toolbar -->
    
    <div class="row">
        <input type="button" class="ButtonMediaService" value="<?php echo __('select avatar') ?>" onclick="btn_service_media_onclick()">
        <!--button class="" data-target="#myModal" data-toggle="modal" onclick="btn_service_media_onclick()"> 
            <i class="glyphicon glyphicon-folder-open"></i> <?php echo __('select avatar');?>
        </button-->
    </div>
    ...
    <div>
        <div class="row">
                ...
                <div class="row" style="padding-top: 30px;">
                    <div class="col-lg-2" style="font-weight: bold; padding-left: 50px;"><?php echo __('status') ?></div>
                    <div class="col-lg-2" style="font-weight: inherit">
                    <label>                    
                    ...
                    <div class=" panel-body col-lg-7" style="float:right;">
                        <div class="table-responsive" id="div_category">
                            <table class="table table-striped table-bordered table-hover" width="100%" class="adminlist" cellspacing="0" border="1">
                                <colgroup>
                                    <col width="5%" />
                                    <col width="95%" />
                                </colgroup>
        ...
        <div class="button-area">
            ...
            <button class="btn btn-outline btn-success" name="btn_update" id="btn_update" onclick="btn_update_banner_onclick()"> 
                <i class="fa fa-check fa-fw"></i> <?php echo __('update'); ?>
            </button>
            <button class="btn btn-outline btn-warning" name="btn_back" id="btn_cancel" onclick="btn_back_onclick()">
