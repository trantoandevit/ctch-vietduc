            ...
            <td valign="top" class="RightContent">
                ...
                <div id="dashboard_interactive">
                    <table id="ctl00_ContentPlaceHolderContent_AdminLeftMenu_dtlMenu" class="TableLeftMenuOverview" cellspacing="0" align="Left" border="0" style="border-width:0px;width:180px;border-collapse:collapse;">
                        <tr>
                            <!--tham do y kien-->
                            <?php if (session::check_permission('QL_DANH_SACH_CUOC_THAM_DO_Y_KIEN',FALSE) > 0): ?>
                                <td class="LeftMenuOverview">
                                    <div class="Content">
                                        <div id="ctl00_ContentPlaceHolderContent_AdminLeftMenu_dtlMenu_ctl09_divRoleImage">
                            ...
                            <?php endif; ?>
                            <!--tham do y kien-->
                            <?php if (session::check_permission('QL_CAU_HOI_DAP',FALSE) > 0): ?>
                                <td class="LeftMenuOverview">
                                    <div class="Content">
                                        <div id="ctl00_ContentPlaceHolderContent_AdminLeftMenu_dtlMenu_ctl09_divRoleImage">
                            ...
                            <!--gop y phan hoi-->
                            <?php if (session::check_permission('QL_GOP_Y_PHAN_HOI',FALSE) > 0): ?>
                            <td class="LeftMenuOverview">
                                <div class="Content">
                                    <div id="ctl00_ContentPlaceHolderContent_AdminLeftMenu_dtlMenu_ctl09_divRoleImage">
                            ...
                            <?php endif;?>
                            <?php if (session::check_permission('QL_CAU_HOI_KHAO_SAT',FALSE) > 0): ?>
                            <td class="LeftMenuOverview">
                                <div class="Content">
                                    <div id="ctl00_ContentPlaceHolderContent_AdminLeftMenu_dtlMenu_ctl09_divRoleImage">
                ...
                <div id="dashboard_system">
                    <table id="ctl00_ContentPlaceHolderContent_AdminLeftMenu_dtlMenu" class="TableLeftMenuOverview" cellspacing="0" align="Left" border="0" style="border-width:0px;width:180px;border-collapse:collapse;">
                        <tr>
                            <?php if (session::check_permission('QL_USER',FALSE) > 0): ?>
                                <td class="LeftMenuOverview">
                                    <div class="Content">
                            ...
                            <?php endif; ?>
                          <?php if (session::check_permission('QL_HE_THONG',FALSE) > 0): ?>
                                <td class="LeftMenuOverview">
                                    <div class="Content">
                                        <div id="ctl00_ContentPlaceHolderContent_AdminLeftMenu_dtlMenu_ctl09_divRoleImage">
                        ...
                        <tr>
                            <?php if (session::check_permission('QL_DON_VI_TRUC_THUOC',FALSE) > 0): ?>
                            <td class="LeftMenuOverview">
                                <div class="Content">
                                    <div id="">
                            ...
                            <?php endif;?>
                            <?php if (session::check_permission('QL_DANH_SACH_THU_TUC_HANH_CHINH',FALSE) > 0): ?>
                            <td class="LeftMenuOverview">
                                <div class="Content">
                                    <div id="">
                ...
                <div id="dashboard_report">
                    <table id="ctl00_ContentPlaceHolderContent_AdminLeftMenu_dtlMenu" class="TableLeftMenuOverview" cellspacing="0" align="Left" border="0" style="border-width:0px;width:180px;border-collapse:collapse;">
                        <tr>
                            <?php if (session::check_permission('QL_BAO_TONG_HOP_DANH_GIA_CAN_BO',FALSE) > 0): ?>
                            <td class="LeftMenuOverview">
                                <div class="Content">
                                    <div id="">
                            ...
                            <?php  endif; ?>
                            <?php if (session::check_permission('QL_BAO_CHI_TIET_DANH_GIA_CAN_BO',FALSE) > 0): ?>
                            <td class="LeftMenuOverview">
                                <div class="Content">
                                    <div id="">
                            ...
                            <?php  endif; ?>
                            <?php if (session::check_permission('QL_BAO_CAO_TONG_HOP_GIAI_QUYET_THU_TUC_HANH_CHINH',FALSE) > 0): ?>
                            <td class="LeftMenuOverview">
                                <div class="Content">
                                    <div id="">
                            ...
                            <?php  endif; ?>
                            <?php if (session::check_permission('QL_BAO_CAO_CHI_TIET_GIAI_QUYET_THU_TUC_HANH_CHINH',FALSE) > 0): ?>
                            <td class="LeftMenuOverview">
                                <div class="Content">
                                    <div id="">
