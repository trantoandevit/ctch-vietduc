...
class article_Controller extends Controller
{
    ...
    public function dsp_general_info($id = 0)
    {
        ...
        $v_catganted = implode(',', Session::get('granted_category'));
        if(trim($v_catganted) != '')
        {
            $c_other_clause         = ' And PK_CATEGORY In(' .  $v_catganted . ')';
        }
    ...
    public function dsp_preview($id = 0)
    {
        ...
        $this->view->set_layout(null)->render('dsp_preview', $data);
    }
    ...
    public function dsp_edit_article($id = 0)
    {
        ...
        $data['v_id'] = $id;
        $this->view->set_layout(null)->render('dsp_edit_article', $data);
    }
    ...
    public function dsp_all_version($id = 0)
    {
        ...
        if (!empty($arr_single_article))
        {
            ...
            $this->view->set_layout(null)->render('dsp_all_version', $data);
        }
        else
        {
            die(__('this object is nolonger available!'));
    ...
    public function dsp_single_version()
    {
        ...
        $this->view->set_layout('pop_win_layout')->render('dsp_single_version', $data);
    }
    ...
    function dsp_all_article_svc()
    {
        ...
        $this->view->set_layout('pop_win_layout')->render('dsp_all_article_svc', $data);
    }
    ...
    private function get_other_clause_by_status()
    {
        ...
        $other_clause_by_status[] = "( FK_INIT_USER = $user_id)";
    ...
    public function dsp_all_tags()
    {
        ...
        $this->view->set_layout('pop_win_layout')->render('dsp_all_tags', $data);
    }
