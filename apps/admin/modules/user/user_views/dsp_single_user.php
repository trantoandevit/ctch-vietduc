...
<form name="frmMain" method="post" id="frmMain" action=""><?php
    ...
    <div class="panel-body" id="tabs_user">
        ...
        <ul class="nav nav-tabs">
            <li class="active"><a href="#user_info" data-toggle="tab"><?php echo __('user personal info')?></a>
            </li>
            <li><a href="#user_group" data-toggle="tab"><?php echo __('in group')?></a>
            </li>
            <li><a href="#user_permit" data-toggle="tab"><?php echo __('grant permission to user')?></a>
            </li>
        </ul>
        ...
        <div class="tab-content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                                ...
                                <td>
                                    <?php if ($v_user_id < 1): ?>
                                        <input type="text" name="txt_login_name" id="txt_login_name"value=""
                                               class="form-control" maxlength="50" style="width:50%"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="password" name="txt_new_password" id="txt_new_password" value=""
                                               ...
                                               data-xml="no" data-doc="no"
                                               />
                                        <label name="pass_check" id="pass_check" class="required" style="float:left;"></label>
                                    </td>
                                </tr>
                                <!--confirm password-->
                                <tr>
                                    ...
                                    <td>
                                        <input type="password" name="txt_confirm_password" id="txt_confirm_new_password" value=""
                                               ...
                                               data-xml="no" data-doc="no"
                                               />
                                        <label name="confirm_pass_check" id="confirm_pass_check" class="required" style="float:left;"></label>
                                    </td>
                                </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group date" id="bg_date" style="width: 50%; display: block;">
                                        <input type='text' name="txt_date_of_birth" value="<?php echo $v_birth_day ?>" id="txt_date_of_birth" 
                                               class="form-control"
                                               data-allownull="no" data-validate="date" 
                                               data-name="<?php echo __('birthday') ?>" 
                                               data-xml="no" data-doc="no" style="width:80%"
                                               autofocus="autofocus" />
                                        <span class="input-group-addon" style="width:20%; height: 34px;">
                                ...
                                <td>
                                    <div class="form-group">
                                        <label class="radio-inline">
                                            <input type="radio" name="rad_sex" id="rad_sex" value="0" <?php echo ($v_gender == '0') ? 'checked' : ''; ?>>Nam
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="rad_sex" id="rad_sex" value="1" <?php echo ($v_gender == '1') ? 'checked' : ''; ?>>Nữ
                                        </label>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="textbox" id="txt_identification_number" name="txt_identification_number" value="<?php echo $v_id_card ?>" size="30"
                                           ...
                                           data-name="Số CMND" class="form-control" style="width:50%;"
                                           data-xml="no" data-doc="no" />
                                </td>
                            </tr>
                            <!--address-->
                            <tr>
                                ...
                                <td>
                                    <textarea style="width: 80%;" name="txt_address" id="txt_address" 
                                              data-allownull="no" data-validate="text"
                                              data-name="địa chỉ" class="form-control"
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="textbox" id="txt_mobile" name="txt_mobile" value="<?php echo $v_mobile ?>" size="30" 
                                           data-allownull="no" data-validate="unsignNumber"
                                           data-name="sđt di động" class="form-control" style="width:50%;"
                                           data-xml="no" data-doc="no"/>
                                </td>
                            </tr>
                            <!--phone-->
                            <tr>
                                ...
                                <td>
                                    <input  type="textbox" id="txt_phone" name="txt_phone" value="<?php echo $v_phone; ?>" size="30" 
                                            ...
                                            data-name="số điện thoại" class="form-control" style="width:50%;"
                                            data-xml="no" data-doc="no"/>
                                </td>
                            </tr>
                            <!--fax-->
                            <tr>
                                ...
                                <td>
                                    <input type="textbox" id="txt_fax" name="txt_fax" value="<?php echo $v_fax; ?>" size="30"
                                           data-allownull="yes" data-validate="unsignNumber"
                                           data-name=" mã fax" class="form-control" style="width:50%;"
                                           data-xml="no" data-doc="no"/>
                                </td>
                            </tr>
                            <!--email-->
                            <tr>
                                ...
                                <td>
                                    <input type="textbox" id="txt_email" name="txt_email" value="<?php echo $v_email; ?>" size="30"
                                           ...
                                           data-name="email" class="form-control" style="width:50%;"
                                           data-xml="no" data-doc="no"/>
                                </td>
                            </tr>
                            <!--thuoc don vi-->
                                ...
                                <td>
                                    ...
                                    <div class="col-sm-10 input-group" style="width: 50%">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-default" onclick="dsp_all_ou_to_add();" type="button">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select onchange="btn_job_title_onchange(this)" class="form-control" style="width: 50%">
            ...
            <div class="tab-pane fade" id="user_group">
                ...
                <div id="group_of_users_action">
                    <button type="button" name="btn_add_group" id="btn_add_group" style="margin: 20px 25px 10px 25px;" class="btn btn-outline btn-primary" onclick="dsp_all_group_to_add();">
                        <i class="fa fa-plus"></i> <?php echo __('join group'); ?>
                    </button>
                    <button type="button" name="btn_remove_group" id="btn_remove_group" style="margin: 10px 25px 10px 25px;" class="btn btn-outline btn-danger" onclick="remove_group_from_user();">
                        <i class="fa fa-times"></i> <?php echo __('leave group'); ?>
                    </button>
                </div>
            </div>
            <!--end thuoc nhom-->
            <!--phan quyen cho nguoi dung------------------------------------------------------------------------------------------------------------------------->
            <div class="tab-pane fade" id="user_permit">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="sel_application" onchange="get_website_permit(this.value)" class="form-control">
                            <option value="">&nbsp;</option>
        ...
        <div class="button-area">
            <button type="button" name="btn_update_user" id="btn_update_user" class="btn btn-outline btn-success" onclick="btn_update_user_onclick();">
                <i class="fa fa-check"></i> <?php echo __('update'); ?>
            </button>
            <?php $v_back_action = ($v_pop_win === '') ? 'btn_back_onclick();' : 'try{window.parent.hidePopWin();}catch(e){window.close();};'; ?>
            <button type="button" name="cancel" id="cancel" class="btn btn-outline btn-danger" onclick="<?php echo $v_back_action; ?>">
...
<script type="text/javascript">
    ...
    function thumbnail_onclick()
    {
        ...
        showPopWin($url, 700, 600, function(json_obj){
            if(json_obj[0])
            {
