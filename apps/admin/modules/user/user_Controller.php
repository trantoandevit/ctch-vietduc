...
class user_Controller extends Controller {
    ...
    function __construct()
    {
        ...
        $this->view->show_div_website = FALSE;
        ...
        if(session::check_permission('QL_USER',FALSE)==FALSE)
        {
    ...
    public function dsp_single_user($user_id)
    {
        ...
        $this->view->set_layout('pop_win_layout')->render('dsp_single_user', $VIEW_DATA);
    }
    ...
    public function dsp_single_group($group_id)
    {
        ...
        $this->view->set_layout('pop_win_layout')->render('dsp_single_group', $VIEW_DATA);
    }
    public function dsp_all_ou_to_add()
    {
        $VIEW_DATA['arr_all_ou'] = $this->model->qry_all_ou();
        $this->view->set_layout('pop_win_layout')->render('dsp_all_ou_to_add',$VIEW_DATA);
    }
    public function dsp_single_ou($ou_id)
    {
        ...
        $this->view->set_layout('pop_win_layout')->render('dsp_single_ou', $VIEW_DATA);
    }
    ...
    public function dsp_ou_tree()
    {
        ...
        $VIEW_DATA['arr_ou_tree'] = $this->dsp_single_groupmodel->qry_ou_tree();
    ...
    public function dsp_all_user_by_ou_to_add()
    {
        ...
        $this->view->set_layout('pop_win_layout')->render('dsp_all_user_by_ou_to_add', $VIEW_DATA);
    }

    public function dsp_all_group_to_add()
    {
        $VIEW_DATA['arr_all_group_to_add'] = $this->model->qry_all_group_to_add();
        $this->view->set_layout('pop_win_layout')->render('dsp_all_group_to_add', $VIEW_DATA);
    }
...
//        echo $website_id;exit;
        ...
        $this->view->set_layout('pop_win_layout')->render('dsp_website_permit', $VIEW_DATA);
    }
}