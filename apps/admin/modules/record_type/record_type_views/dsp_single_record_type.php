...
<div class="row-fluid ">
    ...
    <form name="frmMain" method="post" id="frmMain" enctype="multipart/form-data" action=""class="form-horizontal">
        ...
        ?>
        <h1 class="page-header" style="font-size: 32px;"><?php echo __('update record type');?></h1>
        
        <div class="panel panel-primary">
            <div class="panel-heading">
                <?php echo __('update record type');?>
            </div>
            <div class="panel-body">
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="col-lg-2">
                            <label><?php echo __('code category profile');?> <span class="required">(*)</span></label>
                        </div>
                        <div class="col-lg-4">
                            <input type="text" name="txt_code" value="<?php echo $v_code; ?>" id="txt_code"
                                   ...
                                   data-name="<?php echo __('code category profile');?>"
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="col-lg-2">
                            <label><?php echo __('name category profile');?>  <span class="required">(*)</span></label>
                        </div>
                    <div class="col-lg-6">
                        <textarea name="txt_name" id="txt_name"
                                  class="form-control" data-allownull="no" data-validate="text"
                                  data-name="<?php echo __('name category profile');?>"
                                  data-xml="no" data-doc="no" rows="4"
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                    <div class="col-lg-2">
                        <label><?php echo __('field');?> <span class="required">(*)</span></label>
                    </div>
                    <div class="col-lg-6">
                        <select name="sel_spec_code" id="sel_spec_code" class="form-control" data-allownull="no" data-validate="ddli" 
                ...
                <div class="row">
                    <div class="col-lg-12">
                    <div class="col-lg-2"><label><?php echo __('receiving unit records online');?></label></div>
                <div class="col-lg-6">
                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="full_content code_mapping_<?php echo $v_id; ?>" style="<?php echo ($v_checked != '') ? 'display: block' : 'display: none'?>">
                                        <?php echo __('code corresponding procedures');?>: <input <?php echo ($v_checked == '') ? 'disabled' : ''?> type="textbox"  name="code_mapping[]" value="<?php echo $v_code_mapping?>" >
                                    </label>
                                </td>
                            </tr>
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="col-lg-2"><label><?php echo __('scope'); ?></label></div>
                        <div class="col-lg-6">
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12"> 
                        <div class="col-lg-2"><label><?php echo __('order'); ?> <span class="required">(*)</span></label></div>
                    <div class="col-lg-4">
                        <input type="text" name="txt_order" value="<?php echo $v_order; ?>" id="txt_order"
                               class="form-control" maxlength="50" size="10"
            ...
            <div class="panel-footer">
                <div class="button-area">
                    <button type="button" name="update" class="btn btn-outline btn-success" onclick="btn_record_type_update();">
        ...
        <div class="panel panel-primary" style="border: none;">
            <div class="panel-heading">
                <?php echo __('information guides record type');?>
            </div>
            <div class="panel-body">
                
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="col-lg-2"><label><?php echo __('how to perform'); ?>:</label></div>
                        <div class="col-lg-8">
                            <input type="text" name="cach_thuc_thuc_hien" id="cach_thuc_thuc_hien" value="<?php echo $v_cach_thuc_thuc_hien; ?>" class="form-control" 
                                   data-allownull="yes" data-validate="text"
                                   data-name="<?php echo __('how to perform'); ?>"
                                   data-xml="yes" data-doc="no"
                                   />
                        </div>
                    </div>
                </div><!-- End Cách thực hiện -->
                
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">                       
                    <div class="col-lg-2"><label><?php echo __('time limit for settlement'); ?>:</label></div>
                    <div class="col-lg-8">
                        <input type="text" name="thoi_han_giai_quyet" id="thoi_han_giai_quyet" size="60" value="<?php echo $v_thoi_han_giai_quyet; ?>" class="form-control"
                               data-allownull="yes" data-validate="text"
                               data-name="<?php echo __('time limit for settlement'); ?>"
                               data-xml="yes" data-doc="no"
                               />
                    </div>
                    </div>
                </div><!-- thoi han giai quyet-->
                
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="col-lg-2"><label><?php echo __('subjects execute of administrative procedures'); ?>:</label></div>
                    <div class="col-lg-8">
                        <input type="text" name="doi_tuong_thuc_hien" id="doi_tuong_thuc_hien" size="60" value="<?php echo $v_doi_tuong_thuc_hien; ?>" class="form-control"
                               data-allownull="yes" data-validate="text"
                               data-name="<?php echo __('subjects execute of administrative procedures'); ?>"
                               data-xml="yes" data-doc="no"
                               />
                    </div>
                    </div>
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="col-lg-2"><label><?php echo __('fees'); ?></label></div>
                    <div class="col-lg-10">
                        <textarea type="text" name="le_phi" id="le_phi"
                                  data-allownull="yes" data-validate="text"
                                  data-name="<?php echo __('fees'); ?>"
                                  data-xml="yes" data-doc="no"
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="col-lg-2"><label><?php echo __('the order excuted'); ?>:</label></div>
                    <div class="col-lg-10">
                        <div id="container_trinh_tu_thuc_hien">
                            <textarea id="txta_trinh_tu_thuc_hien" name="txta_trinh_tu_thuc_hien"  
                                      data-allownull="yes" data-validate="text"
                                      data-name="<?php echo __('the order excuted'); ?>"
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="col-lg-2"><label><?php echo __('record'); ?>:</label></div>
                        <div class="col-lg-10">
                            <div id="container_ho_so">
                                <textarea id="txta_ho_so" name="txta_ho_so"  
                                          data-allownull="yes" data-validate="text"
                                          data-name="<?php echo __('record'); ?>"
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="col-lg-2"><label><?php echo __('implementing agencies'); ?>:</label></div>
                    <div class="col-lg-10">
                        <div id="container_co_quan_thuc_hien">
                            <textarea id="txta_co_quan_thuc_hien" name="txta_co_quan_thuc_hien" 
                                      data-allownull="yes" data-validate="text"
                                      data-name="<?php echo __('implementing agencies'); ?>"
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="col-lg-2"><label><?php echo __('result'); ?>:</label></div>
                    <div class="col-lg-10">
                        <div id="container_ket_qua">
                            <textarea id="txta_ket_qua" name="txta_ket_qua"   
                                      data-allownull="yes" data-validate="text"
                                      data-name="<?php echo __('result'); ?>"
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">legal basis
                        <div class="col-lg-2"><label><?php echo __('legal basis'); ?>:</label></div>
                    <div class="col-lg-10">
                        <textarea id="txta_can_cu_phap_ly" name="txta_can_cu_phap_ly"  
                                  data-allownull="yes" data-validate="text"
                                  data-name="<?php echo __('legal basis'); ?>"
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12">
                        <div class="col-lg-2"><label><?php echo __('attach file'); ?>:</label></div>
                    <div class="col-lg-4">
                ...
                <div class="row" style="margin-top: 10px;">
                    <div class="col-lg-12">
                        <div class="col-lg-2"><label><?php echo __('add attach file'); ?>:</label></div>
                    <div class="col-lg-4">
                        ...
                        <div id="box-button-add">
                            <button type="button" class="btn btn-outline btn-primary" onclick="btn_add_file_type_onclick();" ><i class="fa fa-plus"></i> <?php echo __('add new') ?></button>
                        </div>
                    </div>
                    </div>
                </div>
    ...
    <div id="template-list-file" style="display: none">       
        <div class="file-input" data-id="0">
            <input class="form-control" type="text" name="txt_file_type_new[]" id="txt_file_type" required="" style="margin-bottom: 10px;" />
            <label><input class="txt_filietype_name" type="checkbox" name="chk_file_type_old[]" /> <?php echo __('mandatory attachments'); ?></label>&nbsp;
            <button class="btn btn-outline btn-danger" type="button" onclick="btn_delete_file_type_onclick(this)">
