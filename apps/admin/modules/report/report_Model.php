        ...
        if(isset($v_record_type) && trim($v_record_type) >0)
        {
         ...
         $stmt = "  SELECT table_hr_tmp.*,L.C_SPEC_NAME,L.C_SPEC_CODE FROM 	
                    ...
                    (SELECT
                      ...
                      if(COALESCE((COALESCE(HS.C_COUNT_DANG_THU_LY,0) - COALESCE(HS.C_COUNT_THU_LY_QUA_HAN,0)),0) >0,COALESCE((COALESCE(HS.C_COUNT_DANG_THU_LY,0) - COALESCE(HS.C_COUNT_THU_LY_QUA_HAN,0)),0) ,0)  AS C_COUNT_DANG_THU_LY_DUNG_TIEN_DO,
...
//                                SUM(RH.C_COUNT_KY_TRUOC) AS C_COUNT_KY_TRUOC,
        $stmt = "SELECT 
                        ...
                        if(
                        COALESCE((SUM(RH.C_COUNT_DANG_THU_LY) - SUM(RH.C_COUNT_THU_LY_QUA_HAN)),0)>0,COALESCE((SUM(RH.C_COUNT_DANG_THU_LY) - SUM(RH.C_COUNT_THU_LY_QUA_HAN)),0),0)  AS C_COUNT_DANG_THU_LY_DUNG_TIEN_DO,
