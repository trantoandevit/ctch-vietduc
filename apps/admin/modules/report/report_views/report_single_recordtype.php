...
$this->_page_title = __('Báo cáo chi tiết tình hình xử lý hồ sơ');
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header" style="font-size: 32px"><?php echo __('report single recordtype') ?></h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
...
<div class="" id="filter">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <select id="sel_record_list_type" name="sel_record_list_type" style="width: 50%" class="form-control">
