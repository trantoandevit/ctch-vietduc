...
class widget_Controller extends Controller
{
    ...
    public function dsp_all_widget()
    {
        ...
        $this->view->set_layout('default_layout')->render('dsp_all_widget', $data);
    }
    ...
    private function admin_widget_footer()
    {
        ...
        $html .= "<input type='button' class='ButtonAccept btn-update-widget wg-button-accept' 
            value='$v_accept' />";
        $html .= "<input type='button' class='ButtonCancel btn-cancel-widget wg-button-canel' 
            value='$v_close' />";
        $html .= "</form>";
        $html .= '</div>';
        return $html;
   ...
   private function dsp_admin_widget_weather($args = '')
    {
        ...
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_weather', $data);
        $html .= ob_get_clean();
...
//widget poll---------------------------------------------------------------
    ...
    private function dsp_admin_widget_poll($args = '')
    {
        ...
        $html = $this->admin_widget_header();
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_poll', $data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
        return $html;
    }
...
//widget free_text----------------------------------------------------------
    private function dsp_admin_widget_free_text($args = '')
    {
        ...
        $this->view->set_layout(NULL)->render('dsp_admin_widget_free_text', $data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
        return $html;
    }
...
//widget event ------------------------------------------------------------
    private function dsp_admin_widget_event($args = '')
    {
        ...
        $html = $this->admin_widget_header();
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_event', $data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
...
//widget online tv
    private function dsp_admin_widget_online_tv($args = '')
    {
        ...
        $html                = $this->admin_widget_header();
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_online_tv', $data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
...
//widget gallery
    private function dsp_admin_widget_gallery($args = '')
    {
        ...
        $html                = $this->admin_widget_header();
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_gallery',$data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
...
//widget adv ---------------------------------------------------------------
    private function dsp_admin_widget_adv($args = '')
    {
        ...
        $html                = $this->admin_widget_header();
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_adv', $data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
...
//widget category silde
    private function dsp_admin_widget_category_slide($args = '')
    {
        ...
        $html                = $this->admin_widget_header();
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_category_slide', $data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
...
//widget most_visited ---------------------------------------------------
    private function dsp_admin_widget_most_visited($args = '')
    {
        ...
        $html = $this->admin_widget_header();
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_most_visited', $data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
...
//widget support -----------------------------------------------------------
    private function dsp_admin_widget_support($args = '')
    {
        ...
        $html = $this->admin_widget_header();
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_support', $data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
...
//end widget support 
    ...
    private function dsp_admin_widget_weblink($args = '')
    {
        ...
        $html = $this->admin_widget_header();
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_weblink', $data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
    ...
    private function dsp_admin_widget_statistic($args = '')
    {
        ...
        $html = $this->admin_widget_header();
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_statistic', $data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
    ...
    private function dsp_admin_widget_single_category($args = '')
    {
        ...
        $html = $this->admin_widget_header();
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_single_category', $data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
    ...
    private function dsp_admin_widget_media_article($args = '')
    {
        ...
        $html = $this->admin_widget_header();
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_media_article', $data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
     ...
     private function dsp_admin_widget_subscribe($args = '')
    {
        ...
        $html = $this->admin_widget_header();
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_subscribe', $data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
   ...
   private function dsp_admin_widget_video_clip($args = '')
    {
       ...
       $data['txt_video_clip_title'] = '';
        ...
        $html                = $this->admin_widget_header();
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_video_clip', $data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
...
//    Tin anh
    ...
    { 
       ...
       $data['txt_image_news_quantity']  = 0;
        ...
        $html                = $this->admin_widget_header();
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_image_news', $data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
    ...
    { 
       ...
       $data['txt_rating_quantity']  = 0;
        ...
        $html                = $this->admin_widget_header();
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_rating', $data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
    ...
    private function dsp_admin_widget_list_menu_category($args = '')
    {
        try
        {
            $args                 = @new SimpleXMLElement($args, LIBXML_NOCDATA);
            $data['title']       = (string) $args->title;
            $data['menu_display']       = (string) $args->menu_display;
            $data['title_list_menu_category']      = (string) $args->title_list_menu_category;
            $arr_menu = $this->model->qry_all_menu();
            $data['arr_all_position']= $arr_menu['arr_all_position']; 
        }
        catch (Exception $ex)
        {
        ...
        $html = $this->admin_widget_header();
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_list_menu_category', $data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
        return $html;
    }
    private function update_admin_widget_list_menu_category($args = '')
    {
        $v_menu_display             = isset($args['menu_display']) ? (string) $args['menu_display'] : '';
        $v_title_list_menu_category = isset($args['chk_show_title']) ? 1 : 0;
        $v_title                    = isset($args['txt_list_menu_category']) ? $args['txt_list_menu_category'] : '';
        $xml            = "<?xml version='1.0' encoding='utf-8' ?>
            <root>
                <title>$v_title</title>
                <menu_display>$v_menu_display</menu_display>
                <title_list_menu_category>$v_title_list_menu_category</title_list_menu_category>
            </root>
        ";
        return $xml;
    }
//end widget list menu category ---------------------------------------

    //widget Lay tinh trang xu ly ho so mot cua
    private function dsp_admin_widget_tinh_trang_xu_ly_ho_so($args = '')
    {
        $data = array();
        $data['txt_title'] = 'Một cửa điện tử';
        $data['txt_uri']   = 'urn://tyler/req';
         $data['txt_url']  = $data['txt_account']  = $data['txt_password'] = '';
        try
        {
            $args                 = @new SimpleXMLElement($args, LIBXML_NOCDATA);
        ...
        $html = $this->admin_widget_header();
        ob_start();
        $this->view->set_layout(NULL)->render('dsp_admin_widget_tinh_trang_xu_ly_ho_so', $data);
        $html .= ob_get_clean();
        $html .= $this->admin_widget_footer();
        return $html;
    }
    private function update_admin_widget_tinh_trang_xu_ly_ho_so($args = '')
    {
        $txt_title      = isset($args['txt_title']) ? $args['txt_title'] : '';
        $txt_url        = isset($args['txt_url']) ? $args['txt_url'] : ''; 
        $txt_account    = isset($args['txt_account']) ? $args['txt_account'] : ''; 
        $txt_password   = isset($args['txt_password']) ? $args['txt_password'] : ''; 
        $txt_uri        = isset($args['txt_uri']) ? $args['txt_uri'] : ''; 
        
        $xml = "<?xml version='1.0' encoding='utf-8' ?>
            <root>
                <txt_title>$txt_title</txt_title>
                <txt_url>$txt_url</txt_url>
                <txt_account>$txt_account</txt_account>
                <txt_password>$txt_password</txt_password>
                <txt_uri>$txt_uri</txt_uri>
            </root>
        ";
        return $xml;
    }
//end widget Lay tinh trang xu ly ho so ---------------------------------------
}