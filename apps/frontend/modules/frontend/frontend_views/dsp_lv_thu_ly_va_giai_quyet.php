...
?>
<div class="col-md-12">
    <h3 class="synthesis-title margin-top-0" ><?php echo __('status of statistical records')?></h3>
</div>
...
<!--                        <th class="top orange" rowspan="2"><?php echo __('receive')?></th>
                    ...
                    for ($i=0, $n=sizeof($arr_all_report_data); $i<$n; $i++)
                    {
                        ...
                        <tr data-spec-child="<?php echo $v_spec_code?>">
                            <td class="blue" style="width: 25%"><?php echo $v_unit_name;?></td>
<!--                            <td data-format='1' class="orange center"><?php echo $v_total_record;?></td>
                            ...
                            <td data-format='1' class="green center" style="width: 7%"><?php echo $v_dang_thu_ly?></td>
                            <td data-format='1' class="green center" style="width: 7%"><?php echo ($v_dang_thu_ly - $v_thu_ly_qua_han)?></td>
                            <td data-format='1' class="green center" style="width: 7%"><?php echo $v_thu_ly_qua_han?></td>
                            <td data-format='1' class="purple center" style="width: 7%"><?php echo ($v_da_tra_ket_qua_truoc_han + $v_da_tra_ket_qua_dung_han + $v_da_tra_ket_qua_qua_han)?></td>
                            <td data-format='1' class="purple center" style="width: 7%"><?php echo $v_da_tra_ket_qua_truoc_han;?></td>
                            <td data-format='1' class="purple center" style="width: 7%"><?php echo $v_da_tra_ket_qua_dung_han;?></td>
                            <td data-format='1' class="right purple center" style="width: 7%"><?php echo $v_da_tra_ket_qua_qua_han;?></td>
                        </tr>
                        <?php 
                    }//end for i
                    ?>                   
