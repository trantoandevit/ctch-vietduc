...
?>
<div class="col-md-12">
    <h3 class="synthesis-title margin-top-0" ><?php echo __('statistics records for supplements') ?></h3>
</div>
<div class="col-md-12">
...
<!--                        <th class="top orange" rowspan="2"><?php echo __('receive') ?></th>
                ...
                for ($i = 0, $n = sizeof($arr_all_report_data); $i < $n; $i++) {
                    ...
                    <tr data-spec-child="<?php echo $v_spec_code ?>">
                        ...
                        <td data-format='1' class="green center" style="width: 15%"><?php echo $v_bo_sung ?></td>
                        <td data-format='1' class="right green center" style="width: 15%"><?php echo $v_thue; ?></td>
                    </tr>
    <?php
}//end for i
?>
