...
<script>
    ...
    $(document).ready(function () {
        ...
        {
            data_cho_tra.push([data_json[key].C_COUNT_DANG_CHO_TRA_KET_QUA, key]);
            data_som_han.push([data_json[key].C_COUNT_DA_TRA_KET_QUA_TRUOC_HAN, key]);
            data_qua_han.push([data_json[key].C_COUNT_DA_TRA_KET_QUA_QUA_HAN, key]);
            data_dung_han.push([data_json[key].C_COUNT_DA_TRA_KET_QUA_DUNG_HAN, key]);

            data_processing.push([data_json[key].C_COUNT_TONG_TIEP_NHAN_TRONG_THANG, key]);
...
<div class='col-md-12'>
    <div class="col-md-12 block">
        <div class="div-synthesis">
            <h4 class="right-line" style='padding: 0;margin: 10px 20px;'><?php echo __('search') ?></h4>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <label class="col-md-1 control-label"><?php echo __('so sánh') ?></label>
                            <div class="col-md-3">
        ...
        <div class="col-md-12 block">
            <div id="result" class="div-synthesis border-bottom-0">
                <div class='col-md-12'>
                    <h4 class="right-line" style='padding: 0;margin: 10px 20px;'>  <?php echo __('receive chart') . " $v_month/$v_year" ?></h4>
