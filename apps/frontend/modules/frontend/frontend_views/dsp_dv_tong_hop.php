...
?>
<div class="col-md-12">
    <h3 class="synthesis-title margin-top-0" ><?php echo __('Thống kê tổng hợp tình trạng giải quyết hồ sơ theo đơn vị') ?></h3>
</div>
<div class="col-md-12">
        ...
        <form class="form-horizontal" action="" method="post" name="frmMain" id="frmMain" role="form">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6">
                            <label class="control-label col-md-3" style="white-space: nowrap"><?php echo __('field') ?></label>
                            <div class="col-md-9">
                        ...
                        <div class="col-md-6">
                            <label class="control-label col-md-3" style=""><?php echo __('units') ?></label>
                            <div class="col-md-9">
        ...
        <div class="panel-heading uppercase">
            ...
            <table class="table table-bordered">
                ...
                <tr>    
                    ...
                    <th class="purple"><?php echo __('pending'); ?></th>
                ...
                for ($i = 0; $i < count($arr_all_report_data); $i ++):
                    ...
                    <tr class="<?php echo ($i % 2) ? 'xam' : ''; ?>" data-unit="<?php echo $v_unit_code; ?>">
                        ...
                        <td class="purple center bold" style="width: 5%">
                            <?php
                            echo ( $v_da_tra_ket_qua_truoc_han + $v_da_tra_ket_qua_dung_han + $v_da_tra_ket_qua_qua_han + $v_dang_cho_tra_ket_qua + $v_cong_dan_rut + $v_tu_choi
                            )
                            ?>
                        </td>
