...
?>
<div class="col-md-12">
    <h3 class="right-line margin-top-0" ><?php echo __('statistics records for receiving and returning results')?></h3>
</div>
<div class="col-md-12">
    ...
    <div class="col-md-12 block">
        <h4 class="right-line" style='padding: 0;margin: 10px 0'>  <?php echo __('record list') ?></h4>
