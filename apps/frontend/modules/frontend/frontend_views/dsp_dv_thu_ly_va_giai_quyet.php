                ...
                for ($i = 0, $n = sizeof($arr_all_report_data); $i < $n; $i++) {
                    ...
                    if ((($i + 1) <= count($arr_all_report_data)) && ($v_unit_code != $v_cur_unit_code OR $i == 0)):
                        ...
                        <tr data-unit_code="<?php echo $v_unit_code ?>">
                            <td class="end"  style="width: 25%"><?php echo __('total') ?></td>
                            <td data-sum="1" data-format='1' data-index="1" class="center end" style="width: 7%"></td>
                            <td data-sum="1" data-format='1' data-index="2" class="center end" style="width: 7%"></td>
                            <td data-sum="1" data-format='1' data-index="3" class="center end" style="width: 7%"></td>
                            <td data-sum="1" data-format='1' data-index="4" class="center end" style="width: 7%"></td>
                            <td data-sum="1" data-format='1' data-index="5" class="center end" style="width: 7%"></td>
                            <td data-sum="1" data-format='1' data-index="6" class="center end" style="width: 7%"></td>
                            <td data-sum="1" data-format='1' data-index="7" class="center end" style="width: 7%"></td>
