...
define('CONST_DB_DATABASE_NAME', 'ctch-vietduc');
...
//define('CONST_DB_DATABASE_NAME', 'dvc-bac-giang');
//define('CONST_DB_USER_NAME', 'motcua_user');
//define('CONST_DB_USER_PASSWORD', '123456');
//define('DATABASE_TYPE','MYSQL');//Be MSSQL or ORACLE or MYSQL
